...
LOCK TABLES `currency_t` WRITE;
/*!40000 ALTER TABLE `currency_t` DISABLE KEYS */;
/*!40000 ALTER TABLE `currency_t` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `education_t`
--

LOCK TABLES `education_t` WRITE;
/*!40000 ALTER TABLE `education_t` DISABLE KEYS */;
/*!40000 ALTER TABLE `education_t` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `experience_t`
--

LOCK TABLES `experience_t` WRITE;
/*!40000 ALTER TABLE `experience_t` DISABLE KEYS */;
/*!40000 ALTER TABLE `experience_t` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `parts` VALUES (1,2,10,10,10,6,1,'2023-11-27 04:50:31','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL,NULL,0),(5,3,10,10,10,6,1,'2023-12-05 13:40:16','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL,NULL,2);
...
--
-- Dumping data for table `phone_number_t`
--

LOCK TABLES `phone_number_t` WRITE;
/*!40000 ALTER TABLE `phone_number_t` DISABLE KEYS */;
/*!40000 ALTER TABLE `phone_number_t` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `poll_survey` (
  ...
  `residential` tinyint(1) DEFAULT 1,
  ...
  UNIQUE KEY `voter_pk_UNIQUE` (`voter_pk`,`religion_id`,`caste_id`,`party_id`),
  KEY `poll_survey_ibfk_3_idx` (`intrested_party`,`voted_party`),
  KEY `religion_id_idx` (`religion_id`),
  KEY `party_id_idx` (`religion_id`,`caste_id`,`party_id`),
...
INSERT INTO `poll_survey` VALUES (98,1,101,23,NULL,1,'2023-12-05 11:19:34','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL,'9988776655',1,'house_number 1-22','house_number 1-223',79,89,1,0,NULL),(99,10,100,24,NULL,1,'2023-12-05 11:37:31','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL,'9876543210',1,'current_address','villa street - 123456',84,90,1,1,NULL),(100,10,10,23,NULL,1,'2023-12-05 11:38:42','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL,'999999999',1,'current_address','house_number 1-223',81,88,1,1,NULL),(105,1,11,24,NULL,1,'2023-12-06 14:27:55','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL,'9988776654',1,'house_number 1-22','house_number 1-223',80,89,1,0,NULL),(106,1,12,24,NULL,1,'2023-12-06 14:34:12','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL,'9988772654',1,'house_number 1-22','gandhi street 1-223',80,89,1,0,NULL),(107,1,1,23,NULL,1,'2023-12-06 14:55:44','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL,NULL,1,'','',NULL,NULL,NULL,NULL,NULL),(108,1,2,23,NULL,1,'2023-12-06 16:31:40','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL,'999999999',0,'Gandhi ---123456','Villa ----123456',84,90,1,1,NULL),(109,1,3,24,NULL,1,'2023-12-06 16:33:43','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL,'85288888',0,'king street ---12563','queen street ---125634789',84,91,1,1,NULL),(110,1,4,23,NULL,1,'2023-12-07 02:47:05','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL,'9876543201',1,'current_address','',NULL,NULL,0,NULL,NULL);
...
INSERT INTO `user_t` VALUES ('0132843c-eac9-4925-9006-5146a8907425','vijay.sariyam@gmail.com','123@Apple','vijay',' sariyam'),('21b26dc3-ea17-4824-acb1-c0031773be95','xvijay.sariyam@gmail.com','x123@Apple','xvijay','xsariyam'),('3e68170f-e2fe-4f00-8581-7759075b1a68','xvijay.sariyam@gmail.com','x123@Apple','xvijay','xsariyam'),('9d3187b8-2c72-4da8-855c-ffa55c4b08b3','xvijay.sariyam@gmail.com','x123@Apple','xvijay','xsariyam');
...
-- Dump completed on 2023-12-07 11:45:24
