...
CREATE TABLE `ticket_history` (
  ...
  UNIQUE KEY `ticket_attachment_id_UNIQUE` (`ticket_attachment_id`),
  UNIQUE KEY `ticket_master_id_UNIQUE` (`ticket_master_id`),
  KEY `ticket_attachment_id_idx` (`ticket_attachment_id`),
  KEY `ticket_master_id_idx` (`ticket_master_id`),
  CONSTRAINT `ticket_attachment_id` FOREIGN KEY (`ticket_attachment_id`) REFERENCES `ticket_attachments` (`ticket_attachment_pk`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `ticket_master_id` FOREIGN KEY (`ticket_master_id`) REFERENCES `ticket_master` (`ticket_master_pk`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ticket_master` VALUES (4,1,12,5,'not aproved',1,2,1,'2023-11-28 12:43:48','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL),(5,1,11,2,'reason-1',1,2,1,'2023-11-30 08:50:55','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL),(6,4,10,2,'amount not recived',1,1,1,'2023-12-13 16:16:52','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL),(7,5,12,2,'amount not recived',1,1,1,'2023-12-13 16:19:33','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL),(9,6,11,2,'amount issue',1,1,1,'2023-12-13 16:54:33','0000-00-00 00:00:00','0000-00-00 00:00:00',0,NULL,NULL);
...
-- Dump completed on 2023-12-13 22:43:23
